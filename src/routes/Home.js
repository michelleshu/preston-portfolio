        ...
        <Box className="CenteredSectionContent" style={{ maxWidth: "860px" }}>
          ...
          <Flex className="IntroTextMobile" direction="column" gap="4">
            ...
            <Text as="p" size="2" align="center">
              ...
              storytelling through intuitive processes like blindfolded drawing,
              collage, pareidolia, and spontaneous mark-making. Guided by the
              question “What do you see when you close your eyes?”, each piece
              emerges from the closed-eye space where vision is internal and
