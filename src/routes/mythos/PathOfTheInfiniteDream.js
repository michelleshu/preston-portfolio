...
import Void from "../../images/void.jpg";
          ...
          <Box mb="9">
            <Accordion.Root className="AccordionRoot" type="single" collapsible>
              <Accordion.Item className="AccordionItem" value="infinity-planes">
                ...
                <AccordionContent>
                  <Text as="div" mb="4">
                    <em>The Path of the Infinite Dream</em> is not a concept
                    that arrived fully formed. It emerged the way dreams do:
                    through repetition, accumulation, and the slow recognition
                    of patterns that had been present since childhood. Falling.
                    Suspension. Rupture. Dissolution. These were not ideas but
                    sensations, experiences that returned in different forms
                    across a lifetime of dreaming. Over time, they organized
                    themselves into a system: six archetypal states that
                    together form a cycle of total transformation of body, mind,
                    emotion, soul, and spirit.
                  </Text>
                  <Text as="div" mb="4">
                    The Path is structured as a circle, though it is shown
                    linearly. It does not begin at a fixed point or move toward
                    a final destination. It returns. Each cycle is a
                    ...
                    across millennia, Altensien Skybreaker undergoes in the
                    space of a dream.
                  </Text>
                  <Text as="div" mb="4">
                    ...
                    The I and Altensien are not separate. They undergo the
                  ...
                  <Text as="div" mb="4">
                    ...
                    is a moment of contact, of absorption and resistance at
                    once, the body pushing against what it is being pulled into.
                    This interaction is the trigger. The sensation is descent:
                    the body spiraling downward under pressure and gravity,
                    flames erupting from the flesh, darkness pulling endlessly
                    below. This is not a metaphor for failure. It is the
                  ...
                  <Text as="div" mb="4">
                    ...
                    happens: the chest breaks open. A heart made of clouds
                    emerges from within the body and speaks. It does not speak
                    in language but in the way emotion speaks, directly, without
                    translation. Skybreaker must understand what the heart is
                    saying before anything can continue. Thought and emotion
                    overtake the physical. Understanding begins to form, but not
                    in the way it forms in waking life. It forms the way weather
                    forms: diffuse, environmental, surrounding rather than
                    contained. The associated color is blue, expansive and
                    atmospheric. The body is not lost here. It is being asked to
                    feel what it has been carrying.
                  </Text>
                  <Text as="div" mb="4">
                    <strong>The Lightning</strong> arrives the moment
                    understanding is reached. The strike is immediate and total.
                    The body is broken open and struck repeatedly,
                    disintegrating into black, electricity coursing through what
                    remains of the flesh. The structure of the body begins to
                    resemble swirling galaxies, matter reorganized by force
                  ...
                  <Text as="div" mb="4">
                    ...
                    disintegration. Altensien's body is absorbed within a
                    galactic nebula, light rays piercing through from every
                    direction. When Skybreaker comes through the other side, the
                    body is fully rendered but transformed: made entirely of
                    black, of liquid galaxy, stars forming from the feet upward.
                    This is not disintegration but expansion: the self
                    recognized as energy rather than matter, no longer bounded
                    by the form it once held. The associated color is orange,
                    burning and radiant. Altensien is now continuous with the
                    cosmos it moves through.
                  </Text>
                  <Text as="div" mb="4">
                    <strong>The Cosmos</strong> is where the soul takes form.
                    That black body made of liquid galaxy begins to walk a path.
                    Movement slows. Footsteps shape energy. In the distance, two
                    hands hold a black cube, spiraling smoke and clouds pouring
                    from it. Skybreaker walks toward it, becoming more
                    continuous with the surrounding space with every step, the
                  ...
                  <Text as="div" mb="4">
                    ...
                    presence of each archetypal state. Each cube dissolves
                    outward into liquid color: green and orange at the base,
                    rising through yellow and teal, deepening into violet and
                    red at the crown. The whole path is present simultaneously,
                    the body no longer moving through the states one at a time
                    but containing all of them at once. The geometric edges of
                    each form hold their shape just barely as the interior
                    bleeds into the surrounding cosmos. The boundary between
                    body and space is gone. This is what reconfiguration looks
                    like: not destruction, not arrival, but the self becoming
                    continuous with everything it has moved through.
                  </Text>
                  <Text as="div" mb="4">
                    From the pool of souls, the fragments are gathered: dream
                    images, myth symbols, visual language that could not have
                    been reached any other way. These fragments are brought
                    back. They become the work. Then the path returns to The
                    Fall, and Altensien descends again through the portal, and
