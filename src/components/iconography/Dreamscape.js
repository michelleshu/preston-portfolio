...
export default () => {
  const [dreamscapeExpanded, setDreamscapeExpanded] = useState(false);
  ...
  return (
    <Box className="IconographyScrollContainer">
      ...
      <Button
        ...
        color="gold"
        size="2"
        onClick={() => setDreamscapeExpanded(!dreamscapeExpanded)}
      >
        {dreamscapeExpanded ? <TriangleUpIcon /> : <TriangleDownIcon />}
        {dreamscapeExpanded ? "Hide detail" : "Show more detail"}
      </Button>
      ...
      >
        ...
        <Text as="p" className="IconographyParagraph">
          What if the nightmare reflects negativity, just as the dream reflects
          positivity?
        </Text>
        <Text as="p" className="IconographyParagraph">
        ...
        <Text as="p" className="IconographyParagraph">
          But then… what defines a nightmare? Is it fear? Is it confusion? Is it
          the emotional residue left behind?
        </Text>
        <div className="IconographyBreak"></div>
        <Text as="p" className="IconographyParagraph">
          As humans, we’re always trying to define how we feel. But how often do
          we actually understand those feelings?
        </Text>
        <Text as="p" className="IconographyParagraph">
        ...
        <div className="IconographyBreak"></div>
        <Text as="p" className="IconographyParagraph">
          Sometimes I feel conflicted in this world. Can I define something for
          myself? Or will someone else’s ego try to do it for me?
        </Text>
        <div className="IconographyBreak"></div>
        <Text as="p" className="IconographyParagraph">
        ...
        <div className="IconographyBreak"></div>
        <Text as="p" className="IconographyParagraph">
          If someone says they’ve experienced something spiritual, is that not a
          kind of truth?
        </Text>
        <Text as="p" className="IconographyParagraph">
          The astral plane.
        ...
        <div className="IconographyBreak"></div>
        <Text as="p" className="IconographyParagraph">
          Even though I struggle with imbalance, maybe dreams are a way to help
          with that.
        </Text>
        <Text as="p" className="IconographyParagraph">
        ...
        <div className="IconographyBreak"></div>
        <Text as="p" className="IconographyParagraph">
          Each time I sleep, I awaken as another version of myself, exploring a
          different world with its own rules, its own gravity.
        </Text>
        <div className="IconographyBreak"></div>
        <Text as="p" className="IconographyParagraph">
        ...
        <div className="IconographyBreak"></div>
        <Text as="p" className="IconographyParagraph">
          I always feel something complicated when I hear people say they can’t
          dream.
        </Text>
        <Text as="p" className="IconographyParagraph">
        ...
        <Text as="p" className="IconographyParagraph">
          With a set of personal rituals, I can enter a kind of possessed state,
          a focus where I see what’s meant to be seen. Where I can write, study,
          collage, build, contemplate, and understand.
        </Text>
        <div className="IconographyBreak"></div>
        <Text as="p" className="IconographyParagraph">
