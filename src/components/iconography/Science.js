  ...
  return (
    <Box className="IconographyScrollContainer">
      ...
      <Text as="p" className="IconographyParagraph">
        ...
        clouds of dust and gas called nebulae. These clouds collapse under their
        own gravity, and over time, pressure builds. The core heats up,
      ...
      <Text as="p" className="IconographyParagraph">
        ...
        the same pattern. What does that tell you about your pain? Your growth?
        Your dreams?”
      </Text>
    </Box>
  );
