        ...
        <AccordionContent>
          <Box className="IconographyScrollContainer">
            ...
            <Text as="p" className="IconographyParagraph">
              ...
              : humans transition into chaos and change, the descent or ascent
              into understanding, once you fall, you enter the;
            </Text>
            <Text as="p" className="IconographyParagraph">
              <Text as="span" weight="bold">
                Void
              </Text>
              : a place where we can reflect, through the void you contemplate,
            ...
            <Text as="p" className="IconographyParagraph">
              ...
              cloud-state your heart moves, adjusts, listens, feels, molds, and
              when that balance finds charge, you are struck by;
            </Text>
            <Text as="p" className="IconographyParagraph">
              <Text as="span" weight="bold">
                Lightning
              </Text>
              : reaching transcendence, the ability to reach the stars,
            ...
            <Text as="p" className="IconographyParagraph">
              ...
              : becoming one with the cosmos, a place where we all meet, all
            ...
            <Text as="p" className="IconographyParagraph">
              ...
              : the empty sky, a place where closed eyes meet, through the
              dream, you walk the Infinite Planes, where everything is within
              us.
            </Text>
            ...
            >
              ...
              <Text as="p" className="IconographyParagraph">
                As humans, we’re creatures of habit, so does repetition and
                comfort shape that too?
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
              ...
              <Text as="p" className="IconographyParagraph">
                The blessing is in the vividness; the senses, the excitement,
                the realness of the dream.
              </Text>
              <Text as="p" className="IconographyParagraph">
                But the curse...
              </Text>
              <Text as="p" className="IconographyParagraph">
                The curse is knowing I’ll wake up and be confined to this
                so-called “real” world again.
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                This back and forth between the dream and the waking has
                affected me at every stage of life.
              </Text>
              <Text as="p" className="IconographyParagraph">
              ...
              <Text as="p" className="IconographyParagraph">
                The fact that a person, a human being, can come up with
                something entirely new blows my mind.
              </Text>
              <Text as="p" className="IconographyParagraph">
              ...
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                Sure, a cat in your dreams might talk, or a spirit might visit
                you in a trip,
              </Text>
              <Text as="p" className="IconographyParagraph">
              ...
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                I thought stories had to be entirely new, or that I had to do
              ...
              <Text as="p" className="IconographyParagraph">
                The way I could shape and collage everything I’ve felt, seen,
                and imagined into something real.
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
              ...
              <Text as="p" className="IconographyParagraph">
                I used to stare for hours. Clouds felt like moving pictures,
                always shifting, always forming new things.
              </Text>
              <Text as="p" className="IconographyParagraph">
              ...
              <Text as="p" className="IconographyParagraph">
                They broke apart, reformed, and turned into new imagery, new
                meaning.
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
              ...
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                And of course, as someone who stares into the void and the
                sky... I thought of stars.
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                The real void.
              ...
              <Text as="p" className="IconographyParagraph">
                The version of me that dreams into form, even if it’s all been
                thought before.
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                Because I believe that even if the idea has been imagined
                before; you haven’t.
              </Text>
              <Text as="p" className="IconographyParagraph">
              ...
              <Text as="p" className="IconographyParagraph">
                Because what could be more authentic than the part of reality
                that’s made entirely of you?
              </Text>
            </Box>
            <div className="IconographyBreak"></div>
          </Box>
          ...
          <div className="AccordionContentText">
            <Box className="IconographyScrollContainer">
              ...
              <Text as="p" className="IconographyParagraph">
                ...
                dreams, and the void. That we came from stars themselves. That
                to explore creation, I need to follow the birth of a star.
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                Stars are real. They exist. People say God exists too. And if a
                god exists, then other existences can’t be denied. That’s why so
                much is theory and not fact, because the possibility that
                something could be true is what gives it power.
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                We don’t know.
              ...
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                We know we can’t deny another person’s belief. But belief is
                full of contradiction. One person’s immoral is another person’s
                moral. These are human laws. And human laws shift. They can be
                rewritten, consciously, subconsciously, spiritually. That’s what
                gives birth to theory, concept, belief, system, narrative.
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
              ...
              <Text as="p" className="IconographyParagraph">
                ...
                narratives that were placed on me by a society obsessed with
                boxes.
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
              ...
              <Text as="p" className="IconographyParagraph">
                ...
                identity in a way that breathes life into it, not as a label but
                as a force. If I shape a universe with my own rules, beliefs,
                and construction and others find a way into it; could it
              </Text>
              ...
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                And I want to give birth to a world defined by me, my
                experiences, my dreams, my biases, my influences. All of it. All
                that shaped me into who I am. I want to build something real.
                Authentic.
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
              ...
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                I believe religion is one of the most powerful forces in
                existence.
              </Text>
              <Text as="p" className="IconographyParagraph">
        ...
        <Accordion.Content className="AccordionContent">
          <div className="AccordionContentText">
            <Box className="IconographyScrollContainer">
              ...
              <Text as="p" className="IconographyParagraph">
                Something explainable and unexplainable. The definitions are
                vast.
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                States of influence that overlay archetypes and meanings. They
                alter perception, enhance symbolism, and serve as entry points
              ...
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                Two opposing forces, but to me, they’re not good or bad. Not
                even necessarily positive or negative. They just are.
              </Text>
              <Text as="p" className="IconographyParagraph">
                They can exist within those frameworks, sure, but they don’t
              ...
              <Text as="p" className="IconographyParagraph">
                But then… what defines a nightmare? Is it fear? Is it confusion?
                Is it the emotional residue left behind?
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                As humans, we’re always trying to define how we feel. But how
                often do we actually understand those feelings?
              </Text>
              <Text as="p" className="IconographyParagraph">
              ...
              <Text as="p" className="IconographyParagraph">
                I call them memories because the dream creates a life, a story,
                it’s up to us to remember it.
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                But think of a dream as a switch. You close your eyes and wake
                up inside another body, another consciousness, an object,
                anything. But you wake up. Anew.
              </Text>
              <Text as="p" className="IconographyParagraph">
              ...
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                There’s a word for that. Dissociation. That drifting. That
                floating.
              </Text>
              <Text as="p" className="IconographyParagraph">
              ...
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                Sometimes I feel conflicted in this world. Can I define
                something for myself? Or will someone else’s ego try to do it
                for me?
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
              ...
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                If someone says they’ve experienced something spiritual, is that
                not a kind of truth?
              </Text>
              <Text as="p" className="IconographyParagraph">
                The astral plane.
              ...
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                But what I love about dreams is the ability to experience
                something new.
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
              ...
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                Each time I sleep, I awaken as another version of myself,
                exploring a different world with its own rules, its own gravity.
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
              ...
              <Text as="p" className="IconographyParagraph">
                To live without this phenomenon, it might be a blessing. Or a
                curse.
              </Text>
              <Text as="p" className="IconographyParagraph">
              ...
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
                When I dream as Altensien Skybreaker, I gain access to the
                Infinity Planes.
              </Text>
              <Text as="p" className="IconographyParagraph">
                Even when I close my eyes, I can feel that part of me still
                there, like a channel I can tune into.
              </Text>
              <div className="IconographyBreak"></div>
              <Text as="p" className="IconographyParagraph">
