      ...
      <AccordionContent>
        <Box className="IconographyScrollContainer">
          <Text as="p" className="IconographyParagraph">
            First you have to: Fall: humans transition into chaos and change,
            the descent or ascent into understanding, once you fall, you enter
            the;
          </Text>
          <Text as="p" className="IconographyParagraph">
            Void: a place where we can reflect, through the void you
            contemplate, you learn, you change, taking on different forms,
            becoming a;{" "}
          </Text>
          <Text as="p" className="IconographyParagraph">
            Cloud: the state of transformation and understanding emotions, in
            this cloud-state your heart moves, adjusts, listens, feels, molds,
            and when that balance finds charge, you are struck by;
          </Text>
          <Text as="p" className="IconographyParagraph">
          ...
          <div className="IconographyBreak"></div>
          <Text as="p" className="IconographyParagraph">
            Sure, a cat in your dreams might talk, or a spirit might visit you
            in a trip,
          </Text>
          <Text as="p" className="IconographyParagraph">
          ...
          <div className="IconographyBreak"></div>
          <Text as="p" className="IconographyParagraph">
            Because I believe that even if the idea has been imagined before;
            you haven’t.
          </Text>
          <Text as="p" className="IconographyParagraph">
      ...
      <Accordion.Content className="AccordionContent">
        <div className="AccordionContentText">
          <Box className="IconographyScrollContainer">
            ...
            <div className="IconographyBreak"></div>
            <Text as="p" className="IconographyParagraph">
              We know we can’t deny another person’s belief. But belief is full
              of contradiction. One person’s immoral is another person’s moral.
              These are human laws. And human laws shift. They can be rewritten,
              consciously, subconsciously, spiritually. That’s what gives birth
              to theory, concept, belief, system, narrative.
            </Text>
            <div className="IconographyBreak"></div>
            <Text as="p" className="IconographyParagraph">
            ...
            <Text as="p" className="IconographyParagraph">
              ...
              as a force. If I shape a universe with my own rules, beliefs, and
        ...
        <div className="AccordionContentText">
          <Box className="IconographyScrollContainer">
            ...
            <Text as="p" className="IconographyParagraph">
              ...
              alter perception, enhance symbolism, and serve as entry points to
              alternate realities.
            </Text>
            <div className="IconographyBreak"></div>
            <Text as="p" className="IconographyParagraph">
            ...
            <Text as="p" className="IconographyParagraph">
              They can exist within those frameworks, sure, but they don’t have
            ...
            <Text as="p" className="IconographyParagraph">
              ...
              inside another body, another consciousness, an object, anything.
              But you wake up. Anew.
            </Text>
            <Text as="p" className="IconographyParagraph">
